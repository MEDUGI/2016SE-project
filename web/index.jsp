                ...
                <div class="col-md-6">
                    ...
                    <!-- 快速发信 -->
                        ...
                        <div class="tile-header transparent">
                            ...
                            <s:else>
                                <h1><strong>Quick</strong> Message To <s:property value="#session.watchedUsername" /></h1>
                            </s:else>
                            <div class="controls">
                                <a href="#" class="refresh"><i class="fa fa-refresh"></i></a>
                                <a href="#" class="remove"><i class="fa fa-times"></i></a>
                        ...
                        <div class="tile-widget color transparent-black rounded-top-corners">
                            <form class="form-horizontal" role="form" id="quickmsg" action="sendMessage.action" method="post">
                                ...
                                <s:else>
                                    <input name="userTo" value="<s:property value="#session.watchedUsername"/>" hidden>
                                </s:else>
                                <div class="form-group no-bottom-margin">
                                    <label for="subject" class="col-sm-2 control-label font-slab">信件题目</label>
                                    <div class="col-sm-10">
